/* 
	DISCLAIMER: I Did not write the code below, 
 	it is taken from stream-transcoder module, I have some additions in the code,
	It does not worth to create another module out ot if, changes are minor
*/
...
function Transcoder(source) {
  ...
  Transcoder.prototype._parseMetadata = function (child) {
    ...
    var _parseDuration = function (duration) {
      ...
      return parseInt(d[0]) * 60 * 60 * 1000 + parseInt(d[1]) * 60 * 1000 + parseInt(d[2]) * 1000 + parseInt(d[3]);
    };
